                    ...
                    <div class="col-md-6 offset-md-2" style="margin-top: 45px; ">
                        <div class="card">
                            <div class="card-title">
                                <h4 class="p-3 text-center">Add New Arraival</h4><hr
                            </div>
                            <div class="card-body">
                                    
                              <form action="{{ route('backoffice.create-new-arraival') }}" method="post" autocomplete="off">
                                ...
                                @csrf
                                  ...
                                  <div class="form-group">
                                      ...
                                      <a class="btn btn-primary mt-2 float-right" class="text-light" href="{{ URL::previous() }}">Back</a>
                                  </div>
                                  <br>
                              </form>     
                            </div>
