        ...
        <div class="main-panel">
            ...
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="card-description btn btn-info"><a class="text-light" href="{{ route('backoffice.add-unit')}}">Add New unit</a></div>
                        ...
                        <tbody>
                            @foreach($Unit as $values)
                              <tr>
                                ...
                                <td><a class="btn btn-warning" class="text-light" href="{{ route('backoffice.edit-unit',Crypt::encryptString($values->unit_id))}}">Edit</a></td>
