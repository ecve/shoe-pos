                    ...
                    <div class="col-md-6 offset-md-2" style="margin-top: 45px; ">
                        <div class="card">
                            <div class="card-title">
                                <h4 class="p-3 text-center">Edit Brand</h4>
                                <hr
                            </div>
                            <div class="card-body">
                                    
                              <form action="{{ route('backoffice.update-brand') }}" method="post" enctype="multipart/form-data">
                                ...
                                @foreach($Brand as $values)
                                  <input type="hidden" name="id" value="{{$values->brand_id}}">
                                 
                                  <div class="form-group">
                                      <label for="brand_name">Brand Name</label>
                                      <input type="text" class="form-control my-2" name="brand_name" placeholder="Enter Brand Name" value="{{ $values->brand_name }}">
                                      <span class="text-danger">@error('brand_name'){{ $message }} @enderror</span>
                                  </div>
                                  
                                  <div class="form-group">
                                      <label for="brand_logo">Brand Logo</label>
                                      <input type="file" class="form-control my-2" name="brand_logo" placeholder="Enter Brand Logo" value="{{ $values->brand_logo }}">
