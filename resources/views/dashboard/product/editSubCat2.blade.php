                    ...
                    <div class="col-md-6 offset-md-2" style="margin-top: 45px; ">
                        <div class="card">
                            <div class="card-title">
                                <h4 class="p-3 text-center">Edit Sub Category Two</h4><hr
                            </div>
                            <div class="card-body">
                                    
                              <form action="{{ route('backoffice.update-subCat2') }}" method="post" enctype="multipart/form-data">
                                ...
                                @csrf
                                @foreach($subCategoryTwo as $items)
                                  <input name="id" type="hidden" value="{{$items->sc_two_id}}">
                                  <div class="form-group">
                                      <label for="sub_cat2_name">Sub Category Two Name</label>
                                      <input type="text" class="form-control my-2" name="sub_cat2_name" placeholder="Sub Category 2 Name" value="{{ $items->sc_two_name }}">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <select class="form-control my-2" name="sub_cat1_id">
                                          ...
                                          <option value="{{ $values->sc_one_id }}" {{ $items->sc_one_id == $values->sc_one_id ? 'selected' : '' }}>{{$values->sc_one_name}}</option>
                                          @endforeach
                                      </select>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="file" class="form-control my-2" name="sc_two_image" placeholder="Enter Sample Image" value="{{ $items->sc_two_image }}">
