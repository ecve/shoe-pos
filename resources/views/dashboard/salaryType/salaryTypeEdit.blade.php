                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <form action="{{route('backoffice.salary-type-update',$findsalaryType->salary_type_id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                 <div class="row">
                                    <div class="col-md-6">
                                  ...
                                  <div class="form-group ">
                                    <a class="btn btn-primary mt-2 float-right" href="{{route('backoffice.salary-type')}}">Back</a>
