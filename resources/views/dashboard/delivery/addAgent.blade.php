                    ...
                    <div class="col-md-6 offset-md-2" style="margin-top: 45px; ">
                        <div class="card">
                            <div class="card-title">
                                <h4 class="p-3 text-center">Add Delivery Agent</h4>
                                <hr
                            </div>
                            <div class="card-body">
                                    
                              <form action="{{ route('backoffice.create-agent') }}" method="post">
                                ...
                                @csrf
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="delivery_agent_name" placeholder="Enter Delivary Agent Name" value="{{ old('delivery_agent_name') }}">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="agent_contact_no" placeholder="Enter Delivary Agent Contact No" value="{{ old('agent_contact_no') }}">
