                    ...
                    <div class="col-md-6 offset-md-2" style="margin-top: 45px; ">
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <form action="{{ route('backoffice.create-agency') }}" method="post">
                                ...
                                @csrf
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="delivery_agency_name" placeholder="Enter Delivary Agency Name" value="{{ old('delivery_agency_name') }}">
                                 ...
                                 <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="delivery_agency_address" placeholder="Enter Delivary Agency Address" value="{{ old('delivery_agency_address') }}">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control my-2" name="delivery_agency_contact" placeholder="Enter Delivary Agency Contact" value="{{ old('delivery_agency_contact') }}">
