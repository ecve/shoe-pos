...
class ProductController extends Controller
{
    ...
    {
        $subCategoryOne = ProductCategory::where('is_active', 1)->get();
    ...
    public function AllProducts()
    {
        ...
        $Product = Product::join('product_category', 'product_category.category_id', '=', 'products.category_id')
            ->join('unit_definition', 'unit_definition.unit_id', '=', 'products.unit_type')
            //->join('final_stock_table', 'final_stock_table.product_id', '=', 'products.product_id')
            ->select('products.*', 'product_category.category_name', 'unit_definition.unit_name', 'unit_definition.unit_id')//, 'final_stock_table.final_quantity')
            ->get();
    ...
    public function create(Request $request)
    {
        ...
        $Product->category_id = $request->sc_one_id;
    ...
    public function edit($id)
    {
        ...
        $subCategoryOne = ProductCategory::all();
        $UnitDefinition = UnitDefinition::all();
